...
{
    public partial class ADSuccessedOrders : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string sql = "SELECT ID_ORDER, ORDER_DATE, DBO.SUM_ORDER_QUANTITY(ID_ORDER) AS SUM_ORDER_QUANTITY, DBO.ORDER_INFO(ID_ORDER) AS ORDER_INFO, DBO.TOTAL_MONEY_ORDER(ID_ORDER) AS TOTAL_MONEY_ORDER, DBO.SHOW_STATUS(ORDER_STATUS) AS SHOW_STATUS, ORDER_STATUS FROM ORDERS WHERE ORDER_STATUS = 2 ORDER BY ID_ORDER DESC";
